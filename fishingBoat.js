//define function called boatInventory that other modules can invoke in order to see todays catch
const boatInventory = () => {
    //create an array of objects called fishObjects. each object will represent a fish, each containing five properties
    const fishObjects = [
